...
int main() {
    ...
    gpio_set_function(20, GPIO_FUNC_I2C); //4
    gpio_set_function(21, GPIO_FUNC_I2C); //5
    gpio_pull_up(20); //4
    gpio_pull_up(21); //5
    // Make the I2C pins available to picotool
    bi_decl( bi_2pins_with_func(20, 21, GPIO_FUNC_I2C)); //4,5
    ...
    while (1) {
        ...
        sprintf(realTemperatura, "%f", realTemp);
